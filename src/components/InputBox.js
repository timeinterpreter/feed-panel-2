...
function InputBox() {
  ...
  return (
    ...
    <div className="bg-white p-2 rounded-2xl shadow-md text-gray-500 font-medium ml-60 my-14 mx-4">
      <div className="flex space-x-4 p-4 items-center">
        ...
        <form className="flex flex-1">
          ...
          <button 
              ...
              onClick = {uploadPost}
              className="font-semibold text-green-600 pl-2 cursor-pointer space-x-4 "
            >
            Submit
          </button>
        </form>
